...
const Navbar = () => {
  return (
    <nav className="bg-white w-20 h-full border-r-3 border-gray-700 shadow-[6px_0_18px_rgba(0,0,0,0.1)] dark:border-gray-800 dark:shadow-[10px_0_25px_rgba(0,0,0,0.7)] flex flex-col items-center py-7 transition-all rounded-2xl">
